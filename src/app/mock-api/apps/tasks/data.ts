...
export const tasks = [
    ...
    {
        id: 'grados-de-cumplimiento',
        type      : 'task',
        title: 'Grados de cumplimiento',
    ...
    {
        id: 'participacion-de-los-estudiantes-por-facultad',
        type      : 'task',
        title: 'Participación de los estudiantes por facultad',
