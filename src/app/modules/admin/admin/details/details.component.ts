...
import { Mail, MailFolder, MailLabel } from 'app/modules/admin/admin/admin.types';
...
export class AdminDetailsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._adminService.selectedMailChanged
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe(() => {
    ...
    moveToFolder(folderSlug: string): void {
        ...
        this._adminService.updateMail(this.mail.id, { folder: this.mail.folder }).subscribe();
    ...
    toggleLabel(label: MailLabel): void {
        ...
        // Update the mail on the server
        this._adminService.updateMail(this.mail.id, { labels: this.mail.labels }).subscribe();
    ...
    toggleImportant(): void {
        ...
        // Update the mail on the server
        this._adminService.updateMail(this.mail.id, { important: this.mail.important }).subscribe();
    ...
    toggleStar(): void {
        ...
        // Update the mail on the server
        this._adminService.updateMail(this.mail.id, { starred: this.mail.starred }).subscribe();
    ...
    toggleUnread(unread: boolean): void {
        ...
        // Update the mail on the server
        this._adminService.updateMail(this.mail.id, { unread: this.mail.unread }).subscribe();
    }
