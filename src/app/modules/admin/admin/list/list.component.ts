...
import { Mail, MailCategory } from 'app/modules/admin/admin/admin.types';
...
export class AdminListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        // Mails loading
        this._adminService.mailsLoading$
            .pipe(takeUntil(this._unsubscribeAll))
    ...
    onMailSelected(mail: Mail): void {
        ...
        if (mail.unread) {
            ...
            this._adminService.updateMail(mail.id, { unread: false }).subscribe();
        }

        // Execute the mailSelected observable
        this._adminService.selectedMailChanged.next(mail);
    }
