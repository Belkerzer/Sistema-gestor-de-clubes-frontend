...
export class ReportsDetailsComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private _reportsListComponent: ReportsListComponent,
    ...
    ngOnInit(): void {
        // Open the drawer
        this._reportsListComponent.matDrawer.open();
        ...
        this.taskForm.valueChanges
            ...
            .subscribe((value) => {
                ...
                this._reportsService.updateTask(value.id, value).subscribe();
    ...
    ngAfterViewInit(): void {
        ...
        this._reportsListComponent.matDrawer.openedChange
            .pipe(
                takeUntil(this._unsubscribeAll),
    ...
    closeDrawer(): Promise<MatDrawerToggleResult> {
        return this._reportsListComponent.matDrawer.close();
    }
    ...
    createTag(title: string): void {
        ...
        this._reportsService.createTag(tag)
            .subscribe((response) => {
    ...
    updateTagTitle(tag: Tag, event): void {
        ...
        this._reportsService.updateTag(tag.id, tag)
    ...
    deleteTag(tag: Tag): void {
        ...
        this._reportsService.deleteTag(tag.id).subscribe();
    ...
    deleteTask(): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                // Delete the task
                this._reportsService.deleteTask(id)
                    .subscribe((isDeleted) => {
