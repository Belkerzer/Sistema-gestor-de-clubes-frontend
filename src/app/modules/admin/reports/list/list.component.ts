...
export class ReportsListComponent implements OnInit, OnDestroy {
    ...
    createTask(type: 'task' | 'section'): void {
        // Create the task
        this._reportsService.createTask(type).subscribe((newTask) => {
    ...
    toggleCompleted(task: Task): void {
        ...
        this._reportsService.updateTask(task.id, task).subscribe();
    ...
    dropped(event: CdkDragDrop<Task[]>): void {
        ...
        // Save the new order
        this._reportsService.updateTasksOrders(event.container.data).subscribe();
